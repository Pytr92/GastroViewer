...
| [Luftmessnetz UBA/Länder](https://www.umweltbundesamt.de/daten/luft/luftdaten) | Luftqualitätsindex und NO₂/PM der nächsten Messstation, bundesweit | keine Zugriffsbeschränkungen, © UBA/Länder | 1 h (Stationsliste lang) |
| [Bundeswahlleiterin](https://www.bundeswahlleiterin.de/bundestagswahlen/2025/ergebnisse/opendata.html) | Zweitstimmen der BTW 2025 je Wahlkreis + Gemeinde-Zuordnung | dl-de/by-2-0, © Die Bundeswahlleiterin | endgültiges Ergebnis, lange TTL |
...
| `GET /api/point/immobilien?lat=&lon=` | Immobilien-Durchschnittspreise je Bezirk (Statistik Austria: Häuser, Eigentumswohnungen, Baugrund; nur Österreich) |
